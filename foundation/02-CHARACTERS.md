...
## LINGE CHEN, Chief Commissioner (P6 — anchored on finished P5, not a ref)
...
P6 is generated by `edit_image` anchored on the finished P5 page so the hall, bench, commissioners and Seldon stay identical.
...
- `refs/composite_act2_hardin_pirenne.png` — [ref_hardin | ref_pirenne]. Anchor for P9, P10, P12, P15.
