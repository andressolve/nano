...
V3 SOLE SEQUENCE CORRECTION: In every panel Albert wears the DARK NAVY indoor party tailcoat with brass buttons over the pale/ivory waistcoat, matching the navy standing figure in `refs/approved/04-albert.png` and promoted Page 7; never use the pale taupe/cream travel outer coat shown at far right of the reference. Preserve every Page 10 v2 page-critic pass: all seven exact strings and ownership, the forgotten plate resting untouched and unsupported on the window ledge while Albert's hands remain clear of it, the Count's Panel 3 answer visibly delayed because he is already turned or Albert has begun to move on, Panel 4 emptied Count versus oblivious Albert, exactly two Count balloons, Albert/Count identity and value separation, hierarchy, anatomy, continuity, Velvet Cinema register, four-panel architecture, and exact 1024 × 1536 RGB canvas.
