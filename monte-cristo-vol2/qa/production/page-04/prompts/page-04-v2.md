...
V2 MANDATORY CORRECTION ONLY: render EXACTLY SEVEN balloons, no more and no less, in this exact order/map—(1) Panel 1 upper RIGHT, Count: `The Morcerf house is difficult. There are more people in it.`; (2) Panel 2 upper LEFT, Haydée: `There is one more person in it.`; Panel 3 has exactly four: (3) upper LEFT Haydée `I have lived in your house four years and you have never once said her name to me.`; (4) middle LEFT Haydée `You say Mondego. You say the banker, the attorney.`; (5) lower LEFT Haydée `You say the woman.`; (6) lower RIGHT Count `That is enough.`; (7) Panel 4 LEFT Haydée `I am not the one who is afraid of a house.`. Haydée owns exactly five; Count exactly two. `You are not listening to me.` and every other unlisted string are PROHIBITED. Every balloon remains on its owner's side and tail points unambiguously to that owner.
