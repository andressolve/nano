...
V3 MANDATORY CORRECTION ONLY: Panel1 must be unmistakably the single dominant field within approximate 45–70% (aim 55%), visibly dwarfing all lower bands; compress lower panels/coda without dropping content. REMOVE every military portrait and every visible decorated portrait/person from wall/background—no portrait, painted figure, decoration display, orders or ribbons anywhere except the decorations physically worn by live Fernand. Fernand's worn decorations remain the only decorations in frame.
