...
**Output:** `qa/production/page-08/candidates/page-08-v13.png`
...
> 2, 3 and 4 stack in the narrow 25%-wide right column beside it. Panels 5, 6
> and 7 occupy the remaining 18%-tall bottom row. **Fernand holds the left and
...
>
> ### Panel 2 — top of the narrow right column, about 25% wide × 36% tall
>
...
> flattered, and not sure why**. The Count is also visibly present and spatially
> separate in the lower right: show his clean-shaven lower face and mouth above
> his long clean poised hand on the gilt banister. Fernand's moustache and
> receding temple are clearly legible; the Count's mouth is equally clear.
>
> Three warm-ivory balloons in strict tiers. Balloon 1 is Fernand's at the top,
> with a short tail visibly terminating at his upper-left mouth. Balloon 2 is the
> Count's in the middle-right, with a distinct tail running down-right and
> visibly terminating at the Count's lower-right mouth; this tail never points
> up-left, never touches Fernand, and never enters Fernand's decorated shoulder.
> Balloon 3 is Fernand's at bottom-left, with its own separate tail running
> up-left and visibly terminating at Fernand's mouth. No tail is shared.
...
> `I earned it.`
>
> ### Panel 3 — middle of the narrow right column, about 25% wide × 23% tall
>
...
> `In Spain?`
>
> ### Panel 4 — bottom of the narrow right column, about 25% wide × 23% tall
>
...
> `In Greece.`
>
> ### Panel 5 — left 62% of the bottom row, about 62% wide × 18% tall
>
...
>
> ### Panel 6 — middle 14% of the bottom row, about 14% wide × 18% tall
>
...
> `Of course. Greece.`
>
> ### Panel 7 — right 24% of the bottom row, about 24% wide × 18% tall
>
