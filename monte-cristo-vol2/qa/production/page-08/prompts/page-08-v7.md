...
V7 MANDATORY CORRECTIONS ONLY: (1) output must be EXACT 1024×1536 RGB PNG, no other pixel dimensions; (2) Panel 1 staircase walls are plain dark walnut architectural panels plus candle sconces and shadow ONLY—zero framed pictures, zero portraits, zero paintings/tapestries with people, zero sculpted/bas-relief human figures, zero displayed orders/ribbons/decorations. Do not depict any human image on walls. Live Fernand's worn decorations are the only decorations in the page.
