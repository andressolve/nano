...
undrunk.
**Dominant:** the general's staircase, two men climbing it side by side — 51%.
**Locations:** 1. **Panels:** 7.
**Output:** `qa/production/page-08/candidates/page-08-v11.png`
...
>
> **Seven-panel asymmetric-mosaic rule, binding on every panel: do not make
> horizontal strips and do not equalize panel heights.** Panel 1 is one huge
> upper-left rectangle, exactly 68% of page width and 75% of page height. Panels
> 2, 3 and 4 stack in the narrow 32%-wide right column beside it. Panels 5, 6
> and 7 occupy the remaining 25%-tall bottom row. **Fernand holds the left and
> the Count holds the right.**
> The question and answer are isolated: Panel 3 shows only the Count with only
> his question; Panel 4 shows only Fernand with only his answer. Never put `In
> Spain?` and `In Greece.` in the same panel. Panel 5 is a large silent glass
> action. The Count's two final replies occupy separate side-by-side
> one-speaker panels, one balloon each.
>
> ### Panel 1 — **DOMINANT, the huge upper-left 68% wide × 75% tall rectangle, about 51% of the page**
>
> **Hard geometry:** this rectangle begins at the top-left page corner, its right
> separator stands at approximately source x=696 of 1024, and its bottom
> separator stands at approximately source y=1152 of 1536. It is visibly more
> than five times the area of any other panel. Do not turn it into a full-width
...
>
> ### Panel 2 — top of the narrow right column, about 32% wide × 30% tall
>
> Use a clean vertical A-B-A exchange in one continuous close action. Fernand's
> head and decorated shoulder occupy the upper left, **half-turned back —
> flattered, and not sure why**; the Count's long clean poised hand rests on the
> gilt banister in the lower right. Fernand's moustache and receding temple are
> clearly legible. The Count is otherwise off-panel to the right.
>
> Three warm-ivory balloons in strict tiers: Fernand at top with a short tail to
> his mouth; the Count in the middle with its tail exiting right toward him;
> Fernand at bottom with a short tail back to his mouth.
...
> `I earned it.`
>
> ### Panel 3 — middle of the narrow right column, about 32% wide × 22.5% tall
>
...
> `In Spain?`
>
> ### Panel 4 — bottom of the narrow right column, about 32% wide × 22.5% tall
>
...
> `In Greece.`
>
> ### Panel 5 — left 58% of the bottom row, about 58% wide × 25% tall
>
> **The volume's primary motif begins here and must be physically
> unmistakable.** This is a tall bottom-left rectangle from approximately y=1152
> to y=1536. At the left, Fernand's thick ringed hand enters from the top edge and
> suspends a deliberately small full glass. Place its rim near y=1180 and its
> foot no lower than y=1280. The complete raised glass occupies only the upper
> quarter of this panel. From its foot to the bottom separator leave at least 200
> source pixels of uninterrupted empty black space — visibly more than the
> complete height of the raised glass.
> There is no marble,
...
>
> ### Panel 6 — middle 18% of the bottom row, about 18% wide × 25% tall
>
...
> `Of course. Greece.`
>
> ### Panel 7 — right 24% of the bottom row, about 24% wide × 25% tall
>
