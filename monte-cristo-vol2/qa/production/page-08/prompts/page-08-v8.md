...
space in a silent panel. The Count's two final replies then occupy separate
one-speaker panels, one balloon each.

### Panel 1 — **DOMINANT, roughly 45% of the page**, the whole upper portion
...
### Panel 3 — roughly 12%, a wide band below that
...
### Panel 4 — roughly 6%, a narrow one-speaker band
...
### Panel 5 — roughly 6%, a separate one-speaker band
...
### Panel 6 — roughly 10%, a wide silent action band
...
### Panel 7 — roughly 5%, a separate one-speaker reply band

**The Count alone**, face and mouth clearly visible at the right, the flat
answer immediately after his full glass touches stone. Fernand is not visible
and owns no balloon here.

Exactly one warm-ivory balloon at the right with one short tail visibly
terminating at the Count's mouth, exactly:

`Of course. Greece.`

### Panel 8 — roughly 8%, a separate one-speaker closing band

**The Count alone**, face and mouth clearly visible at the right, already
...
px** wide, except the two long strings in panels 3 and 8, which run **wide and
