...
In Panel 3, both Fernand balloons must have long, clearly visible tails that cross and EXIT the Panel 3 boundary toward off-panel Fernand on the Chamber floor. Neither tail may terminate inside Panel 3, enter the ranked-heads area, point at a seated peer, point at Danglars, point at any gallery figure, or create any impression that a visible man owns either line. Every visible peer remains silent.

**PRESERVE EVERY CRITIC-V1-PASSED ELEMENT:** preserve all seven exact strings; Fernand owns exactly six balloons and the Count exactly one; Panel 1 is silent; the Count appears only in the gallery with a hungry face and a normal-sized `Go on. Win it.`; Fernand is visibly winning, fully decorated, warm, upright and in command; one peer is half-rising; Danglars is silent and untroubled with full side whiskers and no moustache; no Haydée or any woman appears; no case, document, open door, torch, candle or warm light appears; and the same cold-daylight Chamber continuity, identities, anatomy, five-panel architecture, dominant turn, Velvet Cinema register and exact 1024 × 1536 RGB canvas remain unchanged. Correct nothing else and do not redesign the page.
