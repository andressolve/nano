...
The document must visibly be the exact same sheet established in promoted Page 18, not a newly redistributed document design. In every visible appearance, and most unmistakably in dominant Panel 2, preserve Page 18's same size and cross-fold pattern; the central broken red wax seal with its separate wax fragments; the distinct dense ink field confined to the LOWER-LEFT quadrant; and the prominent isolated sweeping cursive signature mark in the LOWER-RIGHT quadrant. The lower-right signature must remain visibly separate from the lower-left ink field. All handwriting and the signature-shaped mark remain unreadable marks, never legible words or a readable name.

Preserve every independent-critic-cleared Page 22 v2 essential unchanged, including Panel 1's Count-first reading order—Count at right owns `Give it to me.` and is encountered FIRST, then Haydée at left owns `No.` and is encountered SECOND—plus all seven exact strings and remaining ownership/order; the dominant four-hands-one-document grip; the same Page 18 room, evening, table, lamp, chairs and clothes; exactly three panels; Panel 3 transcription and attribution; the amused, interested Count; both identities; anatomy; Velvet Cinema register; and exact 1024 × 1536 RGB PNG canvas.
