...
V2 MANDATORY CORRECTION ONLY: make panel 4 unmistakably the single dominant panel within 45–70% (aim around 55%); stage the Count's raised right hand as visibly failing—small relative to the frame, unsteady, fingers uneven/partly collapsing, wrist losing force, no rigid flat stop-palm—and keep Haydée visually strong/near enough that her refusal defeats the gesture.
