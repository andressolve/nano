...
**V4 FINAL EXISTING-COMPOSITION MANDATORY CORRECTIONS ONLY:**

1. Panel 3’s case-transfer/carriage field must unmistakably own the page by eye through visual weight: it carries the largest faces, hands, and case, with the strongest selective edges and value focus. Panels 1 and 2 remain clearly subordinate setup bands and must not compete. Do not measure rendered share.
2. In Panel 3 the Count must visibly savor the timing: pleased left-mouth asymmetry, alert delighted eyes, and unmistakable contained enjoyment—not grave, serene, or merely composed.

**PRESERVE EVERY CRITIC-V3-PASSED ELEMENT:** preserve v3’s cleared Panel 5 stair action exactly—Haydée already several risers up the great main flight with multiple steps below her and the case under her arm, while the Count remains entirely off the main flight and moves toward the separate flank public stair. Preserve the same five-panel geometry; all 14 exact strings; Count 8 / Haydée 5 ownership; Panel 3’s five-balloon order; Panel 4’s Haydée / Count / Haydée / Count alternation; the reusable building; the clearly four-hand transfer and full case continuity; both identity locks; the sole tail-free caption; every prohibition; Velvet Cinema register; and exact 1024 × 1536 RGB canvas. Change nothing else and do not redesign the page.
