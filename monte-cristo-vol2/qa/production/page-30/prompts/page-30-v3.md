...
Panel 5 stair action must be visually unambiguous: Haydée is already several risers up the great MAIN front flight, both feet and her entire hem wholly above street level, with multiple stone steps plainly visible below her; her body is ascending toward the main doors and the flat case remains under her arm. She is not on the pavement, not on a landing approach, and not at the foot of the steps. The Count remains entirely off the main flight at RIGHT, moving separately toward the distinct flank public stair.

**PRESERVE EVERY CRITIC-V2-PASSED ELEMENT:** Panel 3 unmistakably owns the page and the façade remains subordinate; preserve all 14 exact strings; Count 8 / Haydée 5 ownership; Panel 3’s five-balloon order; Panel 4’s Haydée / Count / Haydée / Count alternation; the reusable building; the clearly four-hand case transfer and full case-state continuity; the Count’s visible appetite; both identity locks; the sole tail-free caption; every prohibition; the Velvet Cinema register; and the exact 1024 × 1536 RGB canvas. Change nothing else and do not redesign the page.
