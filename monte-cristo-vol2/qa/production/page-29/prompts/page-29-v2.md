...
**BATCH-21–30 V2 MANDATORY CORRECTION ONLY:**

In Panel 3 restore the same simple transparent-glass-chimney oil lamp seen in Page 26 beside the hands and newspaper—NO black shade—and remove every decanter, bottle, tumbler, wine glass, carafe, or other drinking vessel. Panel 3 still shows no face: only two pale hands, the newspaper, the low black table, and that one transparent-chimney lamp.

**PRESERVE EVERY PAGE-29 CRITIC-V1-PASSED ELEMENT:** preserve all seven exact text blocks and their order; exactly two prose fields carrying three paragraphs; Beauchamp’s small oval spectacles, worn dark Paris coat, and stoop; the structurally distinct old Greek man and his hard sleeve grip; old man / Beauchamp / old man Panel 2 ownership; standing unburned Janina; the Janina/Paris palette collision; `JANINA` exactly once with every other newspaper mark unreadable; attribution; anatomy; Velvet Cinema register; and exact 1024 × 1536 RGB canvas. Change nothing else and do not redesign the page.
