...
V2 MANDATORY CORRECTION ONLY: Panel 1 Danglars balloon must read exactly `Danglars. Baron. You'll have heard the name at your bank.` with the opening name present once; preserve every critic-cleared v1 element.
