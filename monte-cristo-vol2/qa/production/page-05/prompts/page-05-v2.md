...
V2 MANDATORY CORRECTION ONLY: make Panel 3 unmistakably the single dominant field at roughly 50–55% of the full page; compress P1+P2 together to about 22–25% and P4 to about 20–23%; Panel 3 must visibly dwarf each other stage and alone carry the aimed-appetite turn, while P4 reads as brief coda.
