...
## V2 MANDATORY CORRECTION ONLY

In dominant Panel 2, lay the SAME recurring Page 22/Page 18 document fully FLAT and FACE-UP under the oil lamp on the black table. It may rest within the Count's hands at its edges, but it must never be upright, vertical, chest-height, facing the camera like a display, or held between him and the viewer. The Count's eyes look past the flat evidence into middle distance, not down to read it. Visibly preserve the promoted document's same size, cross-fold pattern, central broken red wax seal with separate fragments, distinct dense unreadable ink field in the LOWER-LEFT quadrant, and isolated sweeping unreadable cursive signature-shaped mark in the LOWER-RIGHT quadrant. All marks remain unreadable.

Preserve every independent-critic-cleared Page 23 v1 essential unchanged: all five exact strings and their order and ownership; same-minute transfer and room/table/lamp/chairs/clothes continuity; Haydée left and the Count right; the public room remaining spoken only and never shown; exactly four panels with Panel 2 unmistakably dominant; the Count's calculating appetite and Panel 4 mouth asymmetry; Haydée working it out and disliking its simplicity; identities; anatomy; Velvet Cinema register; and exact 1024 × 1536 RGB PNG canvas.
