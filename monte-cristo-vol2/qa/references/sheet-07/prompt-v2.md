...
2. Full-length standing, the stoop, the worn dark coat. **He carries nothing:
   both hands empty, no papers, and no other prop.**
...
4. **The same man in the same Paris coat under hard white southern sun**, a
   ...
   light. **He is bareheaded: no hat, no satchel, no loose papers, and no other
   prop. The notebook is the only prop. Carry it in one hand only; the other
   hand is empty and does not touch it.**
