...
landscape, RGB PNG**, four views of **exactly two related female figures** on a
plain neutral warm-grey ground. No text, no labels, no name plates, no borders.
...
black hair. Plain Epirote child's dress, undyed linen and **exactly one band of
dark embroidery total, placed only at the hem. The neckline and front opening
are plain undyed linen with no embroidery; both cuffs are plain undyed linen
with no embroidery; there is no dark embroidery anywhere except the single
hem band** — **not** the crimson and gold of her adult sheet. Slight, direct,
unsmiling.
