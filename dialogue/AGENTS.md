...
and `ADAPTATION.md`, initialize it under `works/<project-slug>/`, and conduct
only bounded research and adaptation. Research creates understanding, not
...
generation opens before explicit owner approval and a clean adaptation-
readiness check.
...
Each project has `NEW-WORK.md` for preproduction, one active
