# PAGE 34 — builder packet

## Fresh zero-history builder contract

You are a fresh builder for page 34, candidate vK, mode `BASE|TARGETED|FULL_PROMPT_RESET`.
...
- Candidate: `qa/production/page-34/candidates/page-34-vK.png`
- Prompt: `qa/production/page-34/prompts/page-34-vK.md`
- Audit: `qa/production/page-34/audits/page-34-vK.md`
- Proofs: `qa/production/page-34/proofs/page-34-vK-600x900.png` and `…-768x1152.png`
...
```
python3 tools/imagegen.py three-musketeers-vol1 34 K --prompt-file PROMPT.md --ref REF1 --ref REF2 …
```

Then run `python3 tools/check_candidate.py three-musketeers-vol1 34 K`.
