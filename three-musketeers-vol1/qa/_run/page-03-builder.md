# PAGE 3 — builder packet

## Fresh zero-history builder contract

You are a fresh builder for page 3, candidate vK, mode `BASE|TARGETED|FULL_PROMPT_RESET`.
...
## PAGE 3 — the man in the window

### Reader turn
A man with a scar laughs at the yellow horse from a window and refuses to come down, so the boy draws his sword and starts up.

### Ordered moments
1. Panel one, about 30%, a wide strip: the inn yard, low horizon. d'Artagnan on the LEFT swinging down from the yellow horse at the stone trough. Above and to the RIGHT, the first-floor window with shutters open and Rochefort leaning on the sill, hat with the red feather, scar on the left side of his face, laughing down. Two inn men in aprons in the yard on the right, laughing. Rochefort's two balloons sit beside the window, stacked, the upper one first, both tails to his mouth at the sill.
2. Panel two, the dominant panel, about 45%, close and tall: d'Artagnan seen from slightly above, facing the window, hand on the hilt, hair in his eyes, looking up on the LEFT; Rochefort's head and shoulders at the sill on the upper RIGHT, amused. d'Artagnan's balloon upper left with its tail to his mouth; Rochefort's reply lower right, clearly after it, tail to the mouth at the sill.
3. Panel three, about 25%: d'Artagnan with the long sword out, already halfway to the inn door on the RIGHT, seen from behind the two inn men on the LEFT, one lifting a wooden stool and one a broom handle. The boy's single balloon beside his head, tail to his mouth. The inn men are silent and get no balloons.

### Exact strings
ROCHEFORT: `Look at that horse. Is it a horse? It's the colour of a buttercup.`
ROCHEFORT: `Somebody tell the boy. You don't ride a flower to Paris.`
D'ARTAGNAN: `You're laughing at my horse, sir. Come down and laugh at me.`
ROCHEFORT: `At you? I don't fight children. I don't fight anyone before dinner.`
D'ARTAGNAN: `Then you'll be late for dinner.`

Render exactly these 5 strings once each, in this order, with clear ownership; no other text anywhere on the page.

### Character locks
d'Artagnan, keyed to his sheet: eighteen, long narrow face, sharp chin, long straight nose, close-set quick dark eyes, clean-shaven with no moustache, black unruly hair in his eyes, lean and narrow-shouldered, weight forward, one hand on a plain swept-hilt rapier too long for him; faded ochre-yellow doublet, brown breeches and boots, grey felt hat with one broken feather, no cloak (default state, pp 1–32). Rochefort, keyed to his sheet: forty, square hard face, heavy black brows, a pale scar from the LEFT temple to the corner of the mouth visible in every panel; straight black hair to the collar, a thin black moustache, no beard; compact, weight back, chin up; black doublet, black cloak, black hat with a single red feather, the only colour on him (default state, pp 3–34). The risky pair here is d'Artagnan and Rochefort: a beardless boy against a scarred man with a thin moustache; ochre against black; a broken grey feather against a red one; weight forward against weight back. The two inn men: bareheaded, aproned, heavy, faces generic, no feather, no scar, no beard of the Athos kind; silent. The yellow horse keyed to its plate, at the trough.

### Consequential exclusions
The three Musketeers and Constance are absent. The letter is inside the boy's coat and is not seen. No blood anywhere; nobody is struck on this page. Rochefort stays at the window on every panel; he does not come down here. The horse stays unfocal after panel one. No lettering on the inn sign, the shutters, or the trough; no name plates; no sound cue. Only the five spoken strings.
...
- Candidate: `qa/production/page-03/candidates/page-03-vK.png`
- Prompt: `qa/production/page-03/prompts/page-03-vK.md`
- Audit: `qa/production/page-03/audits/page-03-vK.md`
- Proofs: `qa/production/page-03/proofs/page-03-vK-600x900.png` and `…-768x1152.png`
...
```
python3 tools/imagegen.py three-musketeers-vol1 3 K --prompt-file PROMPT.md --ref REF1 --ref REF2 …
```

Then run `python3 tools/check_candidate.py three-musketeers-vol1 3 K`.
