# PAGE 5 — builder packet

## Fresh zero-history builder contract

You are a fresh builder for page 5, candidate vK, mode `BASE|TARGETED|FULL_PROMPT_RESET`.
...
### Reader turn
The boy wakes to an empty pocket, an empty stall, and a shut window, and rides for Paris after the man who took his letter.

### Ordered moments
1. Panel one, about 30%: the stable at evening, the boy sitting up in straw on the LEFT, one hand at the back of his head, his hat beside him, the other hand inside his ochre coat with the inside pocket pulled out and hanging empty and plainly visible. The yellow horse's head looks down over the stall partition on the RIGHT. The boy's single balloon beside his head, tail to his mouth.
2. Panel two, the dominant panel, about 45%, tall: the yard at dusk seen wide and empty, the boy small in the middle of it looking up at the first-floor window, whose shutters are shut; beside him the stable door open on one empty stall. No inn men, no laughter, nobody. The caption sits upper left over the dark wall, tail-free. The boy's balloon sits lower on his side, tail to his mouth.
3. Panel three, about 25%, a strip: the boy in the saddle, hat jammed on, the yellow horse at a gallop out through the yard gate onto the road north, seen from the side. His single balloon beside him, tail to his mouth.

### Exact strings
D'ARTAGNAN: `The letter. My father's letter.`
CAPTION: `The window was shut. The black horse was gone, and everyone in the inn had watched it go.`
D'ARTAGNAN: `He took it. The stable boy says he rode for Paris at noon. With my letter.`
D'ARTAGNAN: `Then so do I.`

Render exactly these 4 strings once each, in this order, with clear ownership; no other text anywhere on the page.

### Character locks
d'Artagnan, keyed to his sheet: eighteen, long narrow face, sharp chin, long straight nose, close-set quick dark eyes, clean-shaven with no moustache, black unruly hair in his eyes, lean and narrow-shouldered, weight forward, one hand on a plain swept-hilt rapier too long for him; faded ochre-yellow doublet, brown breeches and boots, grey felt hat with one broken feather, no cloak (default state, pp 1–32). The yellow horse keyed to its plate. No other figures: the stable boy is not shown, only quoted.

### Consequential exclusions
Rochefort is absent from this page and must not appear at the window or in the yard; the shutters are closed. The three Musketeers and Constance are absent. No blood, no bruise, no bandage on the boy's head. The empty stall is empty. The letter is not on this page. No lettering on the inn, the shutters, or the gate; only the three spoken strings and the one caption.

### Approved image inputs
1. `refs/approved/01-dartagnan.png`
2. `refs/approved/obj-horse.png`
3. `refs/approved/set-meung-yard.png`
...
- Candidate: `qa/production/page-05/candidates/page-05-vK.png`
- Prompt: `qa/production/page-05/prompts/page-05-vK.md`
- Audit: `qa/production/page-05/audits/page-05-vK.md`
- Proofs: `qa/production/page-05/proofs/page-05-vK-600x900.png` and `…-768x1152.png`
...
```
python3 tools/imagegen.py three-musketeers-vol1 5 K --prompt-file PROMPT.md --ref REF1 --ref REF2 …
```

Then run `python3 tools/check_candidate.py three-musketeers-vol1 5 K`.
