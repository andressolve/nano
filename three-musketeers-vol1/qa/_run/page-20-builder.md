...
## PAGE 20 — the lantern in the puddle

### Reader turn
One boy in a white shirt beats four men in the rain as the lantern, visibly broken free from an empty wall bracket, drops the last few inches into the puddle so that only he can see.

### Ordered moments
1. One exterior image, the whole page, about 100%: the narrow street at night in rain, seen a little from above. In the lower foreground, make the falling lantern the unmistakable second focal point: it is fully detached, still lit, tilted in midair only inches above the puddle, with its short broken chain trailing from it. High on the wall behind it, show the former bracket plainly empty, with open air between bracket and lantern; the lantern hangs from nothing and no intact chain connects it to the wall. In the centre the boy in a white shirt owns the page, mid-lunge, a blur of motion, sword out. Around him are exactly four attackers: to the LEFT one sits down hard in the puddle; behind, one runs away up the street; to the RIGHT one's sword leaves his hand into the air; the fourth turns to flee. Constance is flat against the house door on the RIGHT, basket held in front of her. Across the street, upper LEFT, Rochefort stands small and still in a dark doorway, in black with the red feather and arms folded, watching. No blood, no cut, nobody wounded.
2. The sound cue sits beside the detached lantern in large simple letters. The caption sits along the lower edge over a clear field of wet cobbles, tail-free. Nothing else is lettered.

### Exact strings
SOUND: `KLANG`
CAPTION: `The lantern went into the puddle. After that nobody could see him, and he could see everyone.`

Render exactly these 2 strings once each, in this order, with clear ownership; no other text anywhere on the page.

### Character locks
d'Artagnan in shirt sleeves (pp 19–21): the same clean-shaven boy, black hair in his eyes, lean, in a plain white shirt with no doublet, brown breeches and boots, no hat, the too-long plain-hilted rapier in his hand; weight forward. Constance, keyed to her sheet: twenty, small and quick, a head shorter than the boy, round face, soft chin, short straight nose, wide-set hazel eyes, dark brows, a scatter of freckles, dark brown curls pinned up under a white linen cap with strands escaping; slight, straight-backed, hands never idle; a plain dove-grey dress with white cuffs and a white apron whose bib carries one small embroidered gold crown; a ring of iron keys at her waist; a covered wicker basket on her arm (default state, pp 17–27); habitual gesture: chin lifted, looking up a stair. Rochefort, keyed to his sheet: forty, square hard face, heavy black brows, a pale scar from the LEFT temple to the corner of the mouth visible in every panel; straight black hair to the collar, a thin black moustache, no beard; compact, weight back, chin up; black doublet, black cloak, black hat with a single red feather, the only colour on him (default state, pp 3–34). (arms folded in the doorway, silent, not fighting). The four attackers: plain dark cloaks, faces generic, no feather, no scar, no cassock.

### Consequential exclusions
Athos, Porthos, Aramis, and the Cardinal are absent. No blood, no wound. Rochefort does not draw and does not move. Exactly four attackers, all losing. The boy wears no doublet and no hat. The wall bracket is empty; the still-lit lantern is airborne immediately above the puddle and is not hanging from the wall. No lettering except the sound cue and the caption.
...
```
python3 tools/imagegen.py three-musketeers-vol1 20 K --prompt-file PROMPT.md --ref REF1 --ref REF2 …
```

Then run `python3 tools/check_candidate.py three-musketeers-vol1 20 K`.
