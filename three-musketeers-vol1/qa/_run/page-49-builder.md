# PAGE 49 — builder packet

## Fresh zero-history builder contract

You are a fresh builder for page 49, candidate vK, mode `BASE|TARGETED|FULL_PROMPT_RESET`.
...
## PAGE 49 — a man in red at a window

### Reader turn
Four men walk away four abreast down a Paris street, and above them at a window a seated man in red with a cat watches them go.

### Ordered moments
1. One image, the whole page, about 100%, from above and behind: the top of the frame is the inside edge of a window in a house wall, and in it, close and large, the Cardinal seated in profile or three-quarter from behind, red robe and skullcap, grey pointed beard, one long hand stroking a grey cat that sits on the sill, looking down; below and beyond, the narrow Paris street receding, and walking away from the viewer down its middle, four abreast, hats on: the huge one with three red plumes, the small one in ochre with a hand on his hilt in the middle, the slim one with the white plume, the tall one with the white plume on the outside. Overcast Paris light.
2. The caption sits along the lower edge over the cobbles, tail-free. The end card sits small at the very bottom below the caption. Nothing else is lettered.

### Exact strings
CAPTION: `All for one, and one for all. And at a window above the street, a man in red who knew the boy's name.`
TITLE CARD: `End of Volume I`

Render exactly these 2 strings once each, in this order, with clear ownership; no other text anywhere on the page.

### Character locks
The Cardinal, keyed to his sheet: forty-five, a thin ascetic man, long narrow hollow-cheeked face, high forehead, thin high-bridged nose, pale grey hooded eyes that do not blink, pale skin, grey hair cropped close under a red skullcap, a short pointed grey beard and thin grey moustache, both precise, narrow-shouldered, long-fingered; SEATED in a plain high-backed black chair in a robe and short cape of one saturated vermilion red with a small gold cross on a chain; a grey cat on his lap and one long hand stroking it, the hand never still. Never standing, never a sword, never a hat. (seated at the window, the cat on the sill, seen close from behind or in profile; never standing). d'Artagnan, keyed to his sheet: eighteen, long narrow face, sharp chin, long straight nose, close-set quick dark eyes, clean-shaven with no moustache, black unruly hair in his eyes, lean and narrow-shouldered, weight forward, one hand on a plain swept-hilt rapier too long for him; faded ochre-yellow doublet, brown breeches and boots, grey felt hat with one broken feather, no cloak (default state, pp 1–32). Athos, keyed to his sheet's default views: thirty, the tallest man in the book, long pale face, hooded level grey eyes, lines beside the mouth, dark hair straight to the shoulder, a short pointed dark beard and neat moustache, lean; blue cassock with the white cross over a black doublet, black hat with one white plume; NO sling (default state, pp 18–49); hands folded on the pommel of his grounded sword when still; the one man in any panel not moving. Porthos, keyed to his sheet: thirty-five, enormous, the widest man in the book, barrel chest, round ruddy face, small bright eyes, big nose, red-brown curls to the collar, a great red-brown moustache waxed to points, no beard; chest out, fists on hips; blue cassock with the white cross over a crimson doublet, a wide baldric embroidered with gold across the front, black hat with three red ostrich plumes, the largest hat in the book, a gilt-hilted sword; a hand smoothing the baldric. Aramis, keyed to his sheet: twenty-four, slim, fine oval face, small straight nose, large dark eyes, pale skin, fine blond curls to the collar always in order, a small neat blond moustache and lip tuft, no beard; weight on one hip, two fingers at his moustache; immaculate blue cassock with the white cross over dove grey with a wide white lace collar, black hat with one white plume, slim silver-hilted sword, a small book at his belt. The three Musketeers are separated by mass, hair colour, and facial hair before anything else: Athos tall, dark, pointed beard, still; Porthos huge, red-brown curls, waxed moustache, gold baldric, red plumes; Aramis slim, blond, small moustache, lace collar, book. The four are seen from behind and above, small; the hats and silhouettes carry identity.

### Consequential exclusions
The four in the street are not attached; seen from above and behind, small, they are drawn from words, four abreast: Porthos: enormous, red-brown curls, waxed red-brown moustache and no beard, gold-fronted baldric, black hat with three red plumes, blue cassock; d'Artagnan: clean-shaven boy, black hair in his eyes, ochre doublet with mud to the waist, grey hat, no cloak in the middle; Aramis: slim, blond curls to the collar, small neat moustache, white lace collar, blue cassock, one white plume; Athos: tall, dark hair to the shoulder, short pointed dark beard, blue cassock with the white cross, black hat with one white plume, no sling on the outside. The street is not attached; draw it from words: a narrow Paris street of tall leaning houses and wet cobbles, grey-blue slate, seen from a window above. Constance, Rochefort, and Buckingham are absent. The Cardinal is seated; a standing figure at the window is wrong. The four walk away and do not look back. Exactly four in the street. No blood. No lettering except the caption and the end card.

### Approved image inputs
1. `refs/approved/06-cardinal.png`
2. `refs/approved/set-paris.png`
...
- Candidate: `qa/production/page-49/candidates/page-49-vK.png`
- Prompt: `qa/production/page-49/prompts/page-49-vK.md`
- Audit: `qa/production/page-49/audits/page-49-vK.md`
- Proofs: `qa/production/page-49/proofs/page-49-vK-600x900.png` and `…-768x1152.png`
...
```
python3 tools/imagegen.py three-musketeers-vol1 49 K --prompt-file PROMPT.md --ref REF1 --ref REF2 …
```

Then run `python3 tools/check_candidate.py three-musketeers-vol1 49 K`.
