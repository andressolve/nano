...
## PAGE 43 — the Queen came in

### Reader turn
Seen over Constance's shoulder from the gallery, the Queen walks the length of the hall with a blaze of diamonds on her shoulder, and far away a red figure leans forward.

### Ordered moments
Register on this page above all: brush-and-ink line over warm laid paper with opaque matte gouache, visible paper grain, chalky wash edges, the same drawn, painted surface as the ballroom pages before and after it. The polished floor is painted, not rendered: matte gouache with a few broad reflections in brushstrokes, no mirror gloss; the gowns are flat painted silk with ink folds, no satin sheen; candlelight is warm painted light, no lens glow, no bloom, no photographic depth of field. Not smooth prestige-oil realism, not a glossy concept-art render, not a photograph.
1. One image, the whole page, about 100%, seen from the gallery over Constance's shoulder and cap in the near foreground at the lower LEFT, from behind and above: the Queen below, a figure in white and silver with a small crown, seen from behind, walking away down the length of the gold hall between two banks of court bowing like wheat in wind; on her LEFT shoulder a blaze of diamonds in two rows, drawn large and bright as one cluster, the brightest thing on the page. At the far end, small, the dais with the crowned faceless figure, and beside it the red chair with the man in red leaning forward in it and a black figure with a white sling behind.
2. The caption sits along the lower edge over the polished floor, tail-free. Nothing else is lettered.

### Exact strings
CAPTION: `The Queen came in. Nobody looked at her face. Everyone looked at her shoulder.`

Render exactly these 1 strings once each, in this order, with clear ownership; no other text anywhere on the page.

### Character locks
Constance at the ball, keyed to her sheet's view d: the same small freckled girl, dark curls under the white cap, the dove-grey dress with the apron OFF and a plain white collar in its place, no basket, no keys (ball state, pp 41–46). (near foreground, from behind). The Queen is scenery: a figure in white and silver with a small crown, seen from behind or at a distance, face never close, with a blaze of diamonds in two rows on her LEFT shoulder drawn large and bright as one cluster; no balloon. The King is scenery: a crowned figure seated on the dais, no face, no balloon. The court: gold and silver silk, faceless, nobody in red, ochre, or a black doublet. The Cardinal at the ball: as on his sheet, thin, grey pointed beard, red robe and red skullcap, SEATED in a plain chair set beside the dais, no cat; on the arm of the chair under his hand a folded cream letter with a broken red seal. He stands once only, on page 45. (small, far). Rochefort at the ball, keyed to his sheet: hat on with the red feather, the scar from the left temple to the mouth, thin moustache, all black, and his RIGHT arm in a white sling (sling state, pp 42–46); sword sheathed. (small, far).

### Consequential exclusions
The Cardinal and Rochefort are not attached; at the far end of the hall they are small, drawn from words: the Cardinal: thin, grey pointed beard, red robe and red skullcap, seated in a plain chair beside the dais, leaning forward, and behind him Rochefort: black clothes, black hat with one red feather, a scar across one cheek from temple to mouth, thin moustache, right arm in a white sling. d'Artagnan, Athos, Porthos, Aramis, and Buckingham are absent. The Queen's face is never seen; she is from behind. The Cardinal stays seated. No blood. No lettering except the caption. The diamonds are a bright cluster; no attempt to make each stone countable.

### Approved image inputs
1. `refs/approved/05-constance.png`
2. `refs/approved/set-louvre.png`
...
```
python3 tools/imagegen.py three-musketeers-vol1 43 K --prompt-file PROMPT.md --ref REF1 --ref REF2 …
```

Then run `python3 tools/check_candidate.py three-musketeers-vol1 43 K`.
