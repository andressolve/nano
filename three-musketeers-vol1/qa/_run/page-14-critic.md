# PAGE 14 — blind critic entrypoint
...
- `qa/_review/page-14/current/candidate.png`
- `qa/_review/page-14/current/desktop-600x900.png`
- `qa/_review/page-14/current/tablet-768x1152.png`

Stage 2, only after the blind read:

- `qa/_run/page-14-critic-card.md`

Write the report to the neutral path
`qa/_review/page-14/current/critic-report.md`. The orchestrator archives it
after you exit.
