...
### Reader turn
A boy who has never seen three hundred people at once sees all of Paris from the last hill, and none of it looks up.

### Ordered moments
1. One image, the whole page, about 100%: the view down from the last hill into Paris, the road descending in the lower left and filling with carts, riders, and walking figures, all small, all faceless, none looking back; the city spreading up the page to a high horizon: grey-blue slate roofs stacked and crowded, a brown river crossing the middle distance with stone bridges carrying houses, spires and chimney smoke, overcast light with the sun somewhere behind cloud. In the near foreground, lower centre, small against all that, the boy on the yellow horse, hat in his hand, staring.
2. The caption sits lower right over the road, one matte field, tail-free. No other lettering anywhere: no signs, no shop boards, no readable words on the bridges.

### Exact strings
CAPTION: `Paris. He had never seen more than three hundred people in one place. Here they were all at once, and none of them looked up.`

Render exactly these 1 strings once each, in this order, with clear ownership; no other text anywhere on the page.

### Character locks
d'Artagnan, keyed to his sheet: eighteen, long narrow face, sharp chin, long straight nose, close-set quick dark eyes, clean-shaven with no moustache, black unruly hair in his eyes, lean and narrow-shouldered, weight forward, one hand on a plain swept-hilt rapier too long for him; faded ochre-yellow doublet, brown breeches and boots, grey felt hat with one broken feather, no cloak (default state, pp 1–32). The yellow horse keyed to its plate. Every other figure is scenery: small, faceless, no reserved identity stack, no balloon.

### Consequential exclusions
Rochefort, the three Musketeers, and Constance are absent; no red feather, no blue cassock, no red cassock anywhere in the crowd. No lettering except the one caption. The boy stays small; the city is the page. No blood, no drawn sword.
...
```
python3 tools/imagegen.py three-musketeers-vol1 6 K --prompt-file PROMPT.md --ref REF1 --ref REF2 …
```

Then run `python3 tools/check_candidate.py three-musketeers-vol1 6 K`.
