...
## PAGE 11 — a quarter to twelve

### Reader turn
A boy sits on a bench by the river for an hour with three duels and no friend, remembers his father's rule, and stands up at a quarter to twelve.

### Ordered moments
1. Make ONE full-page illustrated-prose plate, not a comic strip, travel sequence, character sheet, reference sheet, montage, collage, or lineup. Reserve a plain parchment text column down the left 46% of the page before drawing anything. Divide that column into exactly three separate, generous prose boxes stacked top to bottom. The three boxes carry the three exact strings below in order, one complete string per box. They must not cross into the picture.
2. The single dominant present-time image fills the right side and continues quietly behind the text column: it is a SITTING scene, not travel. Show exactly one d'Artagnan alone on a stone bench on a grey-stone river quay, the too-long sheathed sword across his knees, hat pushed back, elbows on thighs, looking at nothing. Nobody rides, walks, arrives, or crosses a gate; there is no city gate and no nearby crowd. Across the brown river, small indifferent Paris roofs sit in grey light. High at the right, clear of all text, a church clock shows a quarter to twelve with hands only and no numerals.
3. Beside the middle prose box, place one small warm-edged memory inset, no more than a quarter of the page: the farm gate from page two, the grey-haired father's hand flat on the yellow horse's neck, with the boy above him, all soft and distant. This is the only place the horse appears. The memory is subordinate to the large seated boy and must not become a second equal panel.
4. The attached images are identity reference only. Do not reproduce their multiple views, poses, labels, layout, blank background, or sheet format. Show one seated boy in the present and only the father, boy, and horse together inside the small memory inset. No other lettering; the clock shows no numerals.

### Exact strings
PROSE FIELD 1: `He sat on a bench by the river for an hour and counted what he had. A horse, in a stable he could not pay for. A sword. Three duels, at noon, at one, and at two, with the three best swordsmen in Paris, if the way the other blue cloaks looked at them meant anything, none of whom he had wanted to fight. The man with the scar had got away again. The letter was gone. The Captain would never see him.`
PROSE FIELD 1: `'Never refuse a fight,' his father had said, at the gate, with his hand on the horse. He had not said what to do when you had accepted three.`
PROSE FIELD 1: `At a quarter to twelve d'Artagnan stood up, put his hat on straight, and went to the field behind the Carmelites, because he had said he would.`

Render exactly these 3 strings once each, in this order, with clear ownership; no other text anywhere on the page.

### Character locks
d'Artagnan, keyed to his sheet: eighteen, long narrow face, sharp chin, long straight nose, close-set quick dark eyes, clean-shaven with no moustache, black unruly hair in his eyes, lean and narrow-shouldered, weight forward, one hand on a plain swept-hilt rapier too long for him; faded ochre-yellow doublet, brown breeches and boots, grey felt hat with one broken feather, no cloak (default state, pp 1–32). The father and the yellow horse in the memory panel are the same as on page two: grey-haired man in a worn coat, buttercup-yellow horse. Every other figure is faceless scenery.

### Consequential exclusions
The yellow horse appears only inside the small memory inset, as an old calm buttercup-yellow horse under the father's hand, soft and far; no horse studies, no horse anywhere else on the page. Exactly one boy on the page outside the inset, seated; no standing views of him, no repeated figures.
Athos, Porthos, Aramis, Rochefort, and Constance are absent; no blue cassock close enough to have a face; no red feather anywhere. The sword stays sheathed on his knees. No blood. The clock carries no readable numerals or letters; no shop signs; only the one prose field.
...
```
python3 tools/imagegen.py three-musketeers-vol1 11 K --prompt-file PROMPT.md --ref REF1 --ref REF2 …
```

Then run `python3 tools/check_candidate.py three-musketeers-vol1 11 K`.
