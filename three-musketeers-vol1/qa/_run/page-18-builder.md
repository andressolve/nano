...
### Reader turn
Weeks go by: dawn lessons with Athos, dinners with the four, and every evening a girl looking up a stair at a boy who is there.

### Ordered moments
1. Panel one, the dominant image, about 65%, close and tall: dawn on the Carmelite meadow by the yellow wall, Athos on the RIGHT with NO sling, tall and still, his blade crossed with the boy's, his boot nudging the boy's back foot into place; the boy on the LEFT, hatless, concentrating. Neither speaks. Pale early light, dew.
2. Panel two, about 35%: the steep stair seen from the side or from the top: Constance at the bottom with her basket and her keys, chin lifted, looking up; the boy at the top of the stair looking down. Warm evening lamplight.
3. The prose field sits over the pale field and sky in panel one, a matte parchment field across most of the width, never over the two fencers or the stair. Two paragraphs. No other lettering.

### Exact strings
PROSE FIELD 1: `Weeks went by, and the four of them were never apart. Athos taught him at dawn, on the field where they had met, and said almost nothing, and every morning the boy was harder to hit. Porthos told stories at dinner in which Porthos was always the hero, and paid for the dinner, and pretended Aramis had. Aramis read Latin, and said he would leave for the Church any day now, and never left. Athos offered once to walk him through the Musketeers' gate himself. The boy said not without the letter, and Athos said good, and did not offer again.`
PROSE FIELD 1: `And every evening, when Constance came home from the Louvre with her basket and her keys, she looked up the stair, and he was there, and neither of them said anything about it.`

Render exactly these 2 strings once each, in this order, with clear ownership; no other text anywhere on the page.

### Character locks
d'Artagnan, keyed to his sheet: eighteen, long narrow face, sharp chin, long straight nose, close-set quick dark eyes, clean-shaven with no moustache, black unruly hair in his eyes, lean and narrow-shouldered, weight forward, one hand on a plain swept-hilt rapier too long for him; faded ochre-yellow doublet, brown breeches and boots, grey felt hat with one broken feather, no cloak (default state, pp 1–32). Athos, keyed to his sheet's default views: thirty, the tallest man in the book, long pale face, hooded level grey eyes, lines beside the mouth, dark hair straight to the shoulder, a short pointed dark beard and neat moustache, lean; blue cassock with the white cross over a black doublet, black hat with one white plume; NO sling (default state, pp 18–49); hands folded on the pommel of his grounded sword when still; the one man in any panel not moving. Constance, keyed to her sheet: twenty, small and quick, a head shorter than the boy, round face, soft chin, short straight nose, wide-set hazel eyes, dark brows, a scatter of freckles, dark brown curls pinned up under a white linen cap with strands escaping; slight, straight-backed, hands never idle; a plain dove-grey dress with white cuffs and a white apron whose bib carries one small embroidered gold crown; a ring of iron keys at her waist; a covered wicker basket on her arm (default state, pp 17–27); habitual gesture: chin lifted, looking up a stair. Athos has no sling on this page or any page after.

### Consequential exclusions
Porthos and Aramis are named in the prose but are not drawn on this page; Rochefort and the Cardinal are absent. No blood; the fencing is a lesson. No sling on Athos. No lettering except the one prose field.

### Approved image inputs
1. `refs/approved/01-dartagnan.png`
2. `refs/approved/02-athos.png`
3. `refs/approved/05-constance.png`
4. `refs/approved/set-carmelite-field.png`
5. `refs/approved/set-house.png`
...
```
python3 tools/imagegen.py three-musketeers-vol1 18 K --prompt-file PROMPT.md --ref REF1 --ref REF2 …
```

Then run `python3 tools/check_candidate.py three-musketeers-vol1 18 K`.
