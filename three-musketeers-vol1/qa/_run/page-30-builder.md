# PAGE 30 — builder packet

## Fresh zero-history builder contract

You are a fresh builder for page 30, candidate vK, mode `BASE|TARGETED|FULL_PROMPT_RESET`.
...
- Candidate: `qa/production/page-30/candidates/page-30-vK.png`
- Prompt: `qa/production/page-30/prompts/page-30-vK.md`
- Audit: `qa/production/page-30/audits/page-30-vK.md`
- Proofs: `qa/production/page-30/proofs/page-30-vK-600x900.png` and `…-768x1152.png`
...
```
python3 tools/imagegen.py three-musketeers-vol1 30 K --prompt-file PROMPT.md --ref REF1 --ref REF2 …
```

Then run `python3 tools/check_candidate.py three-musketeers-vol1 30 K`.
