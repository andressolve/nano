# PAGE 12 — blind critic entrypoint
...
- `qa/_review/page-12/current/candidate.png`
- `qa/_review/page-12/current/desktop-600x900.png`
- `qa/_review/page-12/current/tablet-768x1152.png`

Stage 2, only after the blind read:

- `qa/_run/page-12-critic-card.md`

Write the report to the neutral path
`qa/_review/page-12/current/critic-report.md`. The orchestrator archives it
after you exit.
