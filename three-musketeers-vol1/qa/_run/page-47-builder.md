# PAGE 47 — builder packet

## Fresh zero-history builder contract

You are a fresh builder for page 47, candidate vK, mode `BASE|TARGETED|FULL_PROMPT_RESET`.
...
## PAGE 47 — did you arrive?

### Reader turn
One by one, in the order they stopped, the three come up the attic stair and each asks the boy the same question, and Athos says good.

### Ordered moments
1. Four stacked full-width panels. Panel one: the attic late at night by candlelight, the boy on the bed on the LEFT with his boots on and the ring on his hand; Constance a step inside by the window at the back; the door on the RIGHT with Porthos's huge head and shoulders coming through it, a second plain hat crammed on top of his own plumed one. The caption upper left over the dark beam, tail-free. Porthos's line upper right, with a short direct tail to his unobscured mouth; the boy's two words lower left, after it, with a short direct tail to his unobscured mouth.
2. Panel two: Aramis in the doorway on the RIGHT behind Porthos, limping, immaculate, the lace handkerchief still wound round his hand; the boy on the LEFT. Aramis's line upper right, with a short direct tail to his unobscured mouth; the boy's two words lower left, after it, with a short direct tail to his unobscured mouth.
3. Panel three, the largest panel: Athos filling the doorway on the RIGHT, hat in hand, looking at the boy; the boy on the LEFT sitting up. Three balloons alternating and descending: Athos's question upper right, the boy's two words middle left, Athos's one word lower right; each has a short direct tail to its own unobscured mouth; none level. Porthos does not speak in this panel.
4. Panel four, a close two-shot for the joke: Porthos on the LEFT in clear profile, nose wrinkled, facing Athos on the RIGHT. Keep both mouths fully visible and separated from the bed, border, and balloons. Porthos's line upper left with a short direct tail touching his mouth; Athos's last line lower right with a short direct tail touching his mouth. No boy balloon in this panel.

### Exact strings
CAPTION: `They came home that night in the order they had stopped.`
PORTHOS: `I won. I ate the inn. I rode after you, never caught you, rode back. Did anyone see me? Did you arrive?`
D'ARTAGNAN: `I arrived.`
ARAMIS: `I held the bridge till dark. Then, as the Fathers tell us, I walked. It's a long way on one leg. Did you arrive?`
D'ARTAGNAN: `I arrived.`
ATHOS: `Did you arrive?`
D'ARTAGNAN: `I arrived.`
ATHOS: `Good.`
PORTHOS: `Athos. You smell like a hundred barrels.`
ATHOS: `A hundred and six. I counted them. It was a long week.`

Render exactly these 10 strings once each, in this order, with clear ownership; no other text anywhere on the page.

### Character locks
d'Artagnan, keyed to his sheet: clean-shaven boy, black hair in his eyes, ochre doublet with mud to the waist, boots on, a gold ring with a dark stone on his hand. Athos, keyed to his sheet: tallest, long pale unmarked face, dark hair to the shoulder, short pointed dark beard, blue cassock with the white cross, black hat in hand, no sling. The three Musketeers separate by mass, hair colour, and facial hair.

### Consequential exclusions
Porthos, Aramis, and Constance are not attached; draw them from words. Porthos: enormous, red-brown curls, a great waxed red-brown moustache and no beard, blue cassock with the white cross, a black hat with three red plumes and a second plain hat crammed on top of it. Aramis: slim, blond curls to the collar, small neat moustache, white lace collar, blue cassock, limping, a white lace handkerchief round one hand. Constance: a small freckled girl with dark curls under a white cap in a dove-grey dress with a white collar, silent by the window. Exactly one boy, exactly three men returning over the page, one at a time; the final joke panel may show Porthos and Athos together. The attic is not attached; draw it from words: a low room under a beam, one window on a dark street, a bed, a table, a candle, a steep stair beyond the door. Rochefort, the Cardinal, and Buckingham are absent. Constance is present and silent by the window and must stay in the picture. Athos has no sling. No blood; Aramis limps, nothing is bandaged but the hand. No lettering except the caption and the nine spoken strings.
...
- Candidate: `qa/production/page-47/candidates/page-47-vK.png`
- Prompt: `qa/production/page-47/prompts/page-47-vK.md`
- Audit: `qa/production/page-47/audits/page-47-vK.md`
- Proofs: `qa/production/page-47/proofs/page-47-vK-600x900.png` and `…-768x1152.png`
...
```
python3 tools/imagegen.py three-musketeers-vol1 47 K --prompt-file PROMPT.md --ref REF1 --ref REF2 …
```

Then run `python3 tools/check_candidate.py three-musketeers-vol1 47 K`.
