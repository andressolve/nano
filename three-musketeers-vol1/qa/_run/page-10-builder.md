...
## PAGE 10 — the handkerchief

### Reader turn
The boy hands a blond Musketeer the lady's handkerchief he was pretending not to stand on, and gets his third duel of the afternoon.

### Ordered moments
Use exactly four full-width panels stacked in one vertical column. No side-by-side panels, inset panels, character portraits, or reference-sheet montage. Each panel has one uninterrupted outer border, so reading order can only move downward.

1. Top full-width panel: a stone wall, Aramis on the RIGHT with two blue-cloaked Musketeers beyond him, one boot planted on a white lace handkerchief on the cobbles; the boy on the LEFT, slowing, stooping, his fingers on the handkerchief's edge drawing it out from under the boot. The boy's single balloon upper left, tail to his mouth.
2. Second full-width panel, the dominant image: Aramis on the RIGHT taking the handkerchief between two fingers, icy, the small monogram visible but not legible; the two Musketeers looking at it and then at him; the boy on the LEFT, puzzled. Two balloons in strict top-to-bottom order: Aramis's long denial first, high on the right with its tail to his mouth; the boy's question second, clearly lower on the left with its tail to his mouth.
3. Third full-width panel: Aramis on the LEFT, two fingers at his moustache, perfectly polite; the boy on the RIGHT listens. This panel contains only Aramis's duel invitation, high on the left with its tail to his mouth. Give this long balloon ample clear wall and sky behind it.
4. Bottom full-width panel: the same face-to-face staging, Aramis LEFT and the boy RIGHT. Two balloons in strict top-to-bottom order: the boy's answer first, upper right with its tail to his mouth; Aramis's final line second and lowest, on the left with its tail to his mouth. Neither balloon may rise into panel three. The invitation is therefore read before the answer, and the dry final quip lands last at the foot of the page.

### Exact strings
D'ARTAGNAN: `Sir, you've dropped your handkerchief. It's a lady's, I think.`
ARAMIS: `I dropped nothing. That handkerchief is not mine, I have never seen it, and I was standing on it by accident.`
D'ARTAGNAN: `Then why are you taking it?`
ARAMIS: `Because you have embarrassed me in front of my friends, so I shall have to kill you. Two o'clock, behind the Carmelites?`
D'ARTAGNAN: `Two is free. Noon and one are taken.`
ARAMIS: `How busy you are.`

Render exactly these 6 strings once each, in this order, with clear ownership; no other text anywhere on the page.

### Character locks
d'Artagnan, keyed to his sheet: eighteen, long narrow face, sharp chin, long straight nose, close-set quick dark eyes, clean-shaven with no moustache, black unruly hair in his eyes, lean and narrow-shouldered, weight forward, one hand on a plain swept-hilt rapier too long for him; faded ochre-yellow doublet, brown breeches and boots, grey felt hat with one broken feather, no cloak (default state, pp 1–32). Aramis, keyed to his sheet: twenty-four, slim, fine oval face, small straight nose, large dark eyes, pale skin, fine blond curls to the collar always in order, a small neat blond moustache and lip tuft, no beard; weight on one hip, two fingers at his moustache; immaculate blue cassock with the white cross over dove grey with a wide white lace collar, black hat with one white plume, slim silver-hilted sword, a small book at his belt. The risky pair here is d'Artagnan and Aramis, two young men: black rough hair against blond curls; no moustache against a small neat one; ochre with no cloak against the blue cassock and lace collar; weight forward against weight on one hip. The two listening Musketeers: blue cassocks, clean-shaven or full-bearded, never blond, never a pointed dark beard; silent.

### Consequential exclusions
Athos, Porthos, Rochefort, and Constance are absent. The handkerchief carries a small embroidered monogram, not a crown, and no legible letters. No blood. The boy's sword stays sheathed. No lettering on the wall; only the six spoken strings.

### Approved image inputs
1. `refs/approved/01-dartagnan.png`
2. `refs/approved/04-aramis.png`
...
```
python3 tools/imagegen.py three-musketeers-vol1 10 K --prompt-file PROMPT.md --ref REF1 --ref REF2 …
```

Then run `python3 tools/check_candidate.py three-musketeers-vol1 10 K`.
