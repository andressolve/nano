...
## PAGE 41 — the kitchen door

### Reader turn
At the kitchen door of the Louvre the boy puts the box into Constance's hands, she counts to twelve, and she sends him round to stand where the Cardinal can see him.

### Ordered moments
1. Panel one, about 30%: a torchlit service door at the back of the palace, kitchen steam and copper behind it. Constance on the RIGHT in the doorway, grey dress, apron off, white collar, cap; the boy on the LEFT coming up out of the dark with mud to the waist and the closed casket under his arm. Constance's line upper right, tail to her mouth; the boy's answer lower left, after it, tail to his.
2. Panel two, the dominant panel, about 50%, close and tall: the casket open between them in the torchlight, tilted toward her and seen at a steep angle from beside the boy, so that the studs read as one bright cluster of diamonds in two rows and her fingers on the lid and rim cover part of the rows: the diamonds must not be drawn as a flat, fully visible, countable grid, and never as more than twelve. Her face lit over it with her lips moving; his face on the LEFT turned to hers, not to the box. Exactly two hands on the box, hers. Three balloons: Constance's count upper right, tail to her mouth; the boy's long line middle left, after it, tail to his; his short line below it on his side.
3. Panel three, about 20%: Constance on the RIGHT with the box shut against her chest, already turning up a stone stair into the light; the boy on the LEFT sat down on the bottom step. Three balloons A–B–A: Constance's instruction upper right, the boy's line middle left, Constance's three words lowest right, tails to each mouth, none level.

### Exact strings
CONSTANCE: `You're here. Every night since you left I've stood in this door. Is it—`
D'ARTAGNAN: `Twelve. Count them.`
CONSTANCE: `Ten. Eleven. Twelve. Twelve.`
D'ARTAGNAN: `Two of them are new. The scar cut two out at the Duke's ball, and the Duke had two made. Nobody can tell which.`
D'ARTAGNAN: `Not even the Duke could.`
CONSTANCE: `She's dressing. She has ten minutes. Go round to the front doors and stand where she can see you.`
D'ARTAGNAN: `Where the Cardinal can see me.`
CONSTANCE: `Yes. That too.`

Render exactly these 8 strings once each, in this order, with clear ownership; no other text anywhere on the page.

### Character locks
d'Artagnan, keyed to his sheet: eighteen, long narrow face, sharp chin, long straight nose, close-set quick dark eyes, clean-shaven with no moustache, black unruly hair in his eyes, lean and narrow-shouldered, weight forward, one hand on a plain swept-hilt rapier too long for him; faded ochre-yellow doublet, brown breeches and boots, grey felt hat with one broken feather, no cloak (default state, pp 1–32; road-dusty from page 28, mud to the waist from page 33). The boy has mud to the waist and holds his hat in his hand indoors (mud state, pp 33–46). Constance at the ball, keyed to her sheet's view d: the same small freckled girl, dark curls under the white cap, the dove-grey dress with the apron OFF and a plain white collar in its place, no basket, no keys (ball state, pp 41–46). The casket keyed to its plate, twelve studs, no empty slot; the reader is never asked to count. Kitchen figures, if any: faceless, silent.

### Consequential exclusions
Athos, Porthos, Aramis, Rochefort, the Cardinal, and Buckingham are absent. The Queen does not appear. Constance wears no apron and carries no basket. No empty slot in the casket on this page. No blood. No lettering on the door or the copper; only the eight spoken strings.

### Approved image inputs
1. `refs/approved/01-dartagnan.png`
2. `refs/approved/05-constance.png`
3. `refs/approved/obj-casket-pouch-ring.png`
4. `refs/approved/set-louvre.png`
...
```
python3 tools/imagegen.py three-musketeers-vol1 41 K --prompt-file PROMPT.md --ref REF1 --ref REF2 …
```

Then run `python3 tools/check_candidate.py three-musketeers-vol1 41 K`.
