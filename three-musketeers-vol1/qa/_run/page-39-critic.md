# PAGE 39 — blind critic entrypoint
...
- `qa/_review/page-39/current/candidate.png`
- `qa/_review/page-39/current/desktop-600x900.png`
- `qa/_review/page-39/current/tablet-768x1152.png`

Stage 2, only after the blind read:

- `qa/_run/page-39-critic-card.md`

Write the report to the neutral path
`qa/_review/page-39/current/critic-report.md`. The orchestrator archives it
after you exit.
