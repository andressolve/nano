...
```
python3 tools/imagegen.py three-musketeers-vol1 31 K --prompt-file PROMPT.md --ref REF1 --ref REF2 …
```

Then run `python3 tools/check_candidate.py three-musketeers-vol1 31 K`.
