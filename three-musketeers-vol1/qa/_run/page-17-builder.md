...
## PAGE 17 — two livres a week

### Reader turn
The boy rents an attic from a girl who dresses the Queen every morning, and is finished the moment she looks down the stair at him.

### Ordered moments
1. Panel one, about 30%, a strip: a narrow street; the house door on the RIGHT at the foot of a steep wooden stair, Constance on the doorstep in grey and white, cap, keys, basket, the small gold crown on her apron; the boy on the LEFT on the cobbles holding the yellow horse's rein, hat in his hands. Four balloons as two single-speaker beats read left to right and down: the boy's introduction upper left, Constance's rent middle right, the boy's promise lower left, Constance's answer lowest right; each tail to its own mouth; no two level.
2. Panel two, the dominant panel, about 45%, tall, seen from the foot of the stair looking up: Constance a few steps up on the RIGHT with a candle, turned to look down; the boy at the foot on the LEFT looking up; the gold crown on her apron bib catching the candlelight. The boy's line lower left by his mouth; Constance's reply upper right by hers.
3. Panel three, about 25%: the attic, one window on the street, a bed, a table, a candle; the boy on the LEFT hanging the too-long sword on a nail in the beam; Constance on the RIGHT in the doorway. The boy's line upper left, tail to his mouth; Constance's last line lower right, tail to hers.

### Exact strings
D'ARTAGNAN: `I'm d'Artagnan. Athos says you have an attic.`
CONSTANCE: `Two livres a week, and the stair is steep. Can you pay it?`
D'ARTAGNAN: `Not this week. Next week I'll be famous.`
CONSTANCE: `Everyone who comes to Paris says that.`
D'ARTAGNAN: `There's a crown on your apron.`
CONSTANCE: `I dress the Queen. Every morning, at the Louvre. Then I come home and let attics to Gascons who can't pay.`
D'ARTAGNAN: `I'll pay. I'll pay double. What's your name?`
CONSTANCE: `Constance. Double is four livres. Goodnight.`

Render exactly these 8 strings once each, in this order, with clear ownership; no other text anywhere on the page.

### Character locks
d'Artagnan, keyed to his sheet: eighteen, long narrow face, sharp chin, long straight nose, close-set quick dark eyes, clean-shaven with no moustache, black unruly hair in his eyes, lean and narrow-shouldered, weight forward, one hand on a plain swept-hilt rapier too long for him; faded ochre-yellow doublet, brown breeches and boots, grey felt hat with one broken feather, no cloak (default state, pp 1–32). Constance, keyed to her sheet: twenty, small and quick, a head shorter than the boy, round face, soft chin, short straight nose, wide-set hazel eyes, dark brows, a scatter of freckles, dark brown curls pinned up under a white linen cap with strands escaping; slight, straight-backed, hands never idle; a plain dove-grey dress with white cuffs and a white apron whose bib carries one small embroidered gold crown; a ring of iron keys at her waist; a covered wicker basket on her arm (default state, pp 17–27); habitual gesture: chin lifted, looking up a stair. The yellow horse keyed to its plate, in panel one only.

### Consequential exclusions
Athos, Porthos, Aramis, Rochefort, and the Cardinal are absent. No blood. The sword ends the page on the nail. The crown on the apron is a small embroidered emblem, not a jewel, and carries no letters. No lettering on the house, the door, or the stair; only the eight spoken strings.

### Approved image inputs
1. `refs/approved/01-dartagnan.png`
2. `refs/approved/05-constance.png`
3. `refs/approved/obj-horse.png`
...
```
python3 tools/imagegen.py three-musketeers-vol1 17 K --prompt-file PROMPT.md --ref REF1 --ref REF2 …
```

Then run `python3 tools/check_candidate.py three-musketeers-vol1 17 K`.
