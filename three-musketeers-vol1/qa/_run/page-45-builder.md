# PAGE 45 — builder packet

## Fresh zero-history builder contract

You are a fresh builder for page 45, candidate vK, mode `BASE|TARGETED|FULL_PROMPT_RESET`.
...
### Reader turn
The Cardinal stands for the only time in the book, sees a muddy boy in the last doorway, and reads the boy's name off the letter stolen at Meung.

### Ordered moments
1. Panel one, the dominant panel, about 55%, wide and tall: the Cardinal on the RIGHT, standing, the red robe falling straight, turned from the dais toward the long doors along the hall; Rochefort behind him with the white sling; and far down the hall on the LEFT, in the last of the long doors, small but unmistakable against the gold, the boy in muddy ochre with his hat in his hand and his hair in his eyes, looking straight back across the whole room. The Cardinal's question upper right, tail to his mouth; Rochefort's answer below it on his side, tail to his.
2. Panel two, about 45%, close: the Cardinal's long hand taking a folded cream letter with a broken red seal from the arm of the plain chair beside him and unfolding it, his eyes on the foot of the page; the writing indistinct. Two balloons stacked on his side, the letter line first, the name alone below it, both tails to his mouth.

### Exact strings
CARDINAL: `Who is that boy?`
ROCHEFORT: `The Gascon. From Meung.`
CARDINAL: `Ah. The letter. A father asking a favour for a son.`
CARDINAL: `d'Artagnan.`

Render exactly these 4 strings once each, in this order, with clear ownership; no other text anywhere on the page.

### Character locks
The Cardinal at the ball: as on his sheet, thin, grey pointed beard, red robe and red skullcap, SEATED in a plain chair set beside the dais, no cat; on the arm of the chair under his hand a folded cream letter with a broken red seal. On this page, and only this page, he STANDS. Rochefort at the ball, keyed to his sheet: hat on with the red feather, the scar from the left temple to the mouth, thin moustache, all black, and his RIGHT arm in a white sling (sling state, pp 42–46); sword sheathed. d'Artagnan, keyed to his sheet: eighteen, long narrow face, sharp chin, long straight nose, close-set quick dark eyes, clean-shaven with no moustache, black unruly hair in his eyes, lean and narrow-shouldered, weight forward, one hand on a plain swept-hilt rapier too long for him; faded ochre-yellow doublet, brown breeches and boots, grey felt hat with one broken feather, no cloak (default state, pp 1–32; road-dusty from page 28, mud to the waist from page 33). The boy has mud to the waist and holds his hat in his hand indoors (mud state, pp 33–46). (small, in the far doorway). The Queen is scenery: a figure in white and silver with a small crown, seen from behind or at a distance, face never close, with a blaze of diamonds in two rows on her LEFT shoulder drawn large and bright as one cluster; no balloon. The King is scenery: a crowned figure seated on the dais, no face, no balloon. The court: gold and silver silk, faceless, nobody in red, ochre, or a black doublet. The letter keyed to the letters plate, broken-seal state, no legible words.

### Consequential exclusions
Rochefort is not attached; behind the Cardinal he is drawn from words: Rochefort: black clothes, black hat with one red feather, a scar across one cheek from temple to mouth, thin moustache, right arm in a white sling. The letter: a folded cream paper with a broken red wax seal, no legible writing. Athos, Porthos, Aramis, Constance, and Buckingham are absent from this page; the Queen and court are background only. The Cardinal has no cat. The name is spoken, never written legibly on the letter. No blood. No lettering except the four spoken strings.

### Approved image inputs
1. `refs/approved/06-cardinal.png`
2. `refs/approved/01-dartagnan.png`
...
- Candidate: `qa/production/page-45/candidates/page-45-vK.png`
- Prompt: `qa/production/page-45/prompts/page-45-vK.md`
- Audit: `qa/production/page-45/audits/page-45-vK.md`
- Proofs: `qa/production/page-45/proofs/page-45-vK-600x900.png` and `…-768x1152.png`
...
```
python3 tools/imagegen.py three-musketeers-vol1 45 K --prompt-file PROMPT.md --ref REF1 --ref REF2 …
```

Then run `python3 tools/check_candidate.py three-musketeers-vol1 45 K`.
