# The Three Musketeers, Volume I — reader critic
...
- `books/three-musketeers-vol1/index.html`
- canonical `books/three-musketeers-vol1/pages/page-01.png` through `page-49.png`
  only as the reader references them
- the output of `python3 books/three-musketeers-vol1/qa/_publication/verify-reader.py`
...
`#page-1`, `#page-49`, `#end`, `#quiz`, and an out-of-range hash; the contents
...
1. Page 1 loads with the correct title, counter, and movement; every page
   index maps to `pages/page-NN.png` for 1–49 and nothing beyond.
2. Previous/next, page-edge, keyboard, touch, `#page-N` reload, and saved
   position behave coherently at both ends of the book.
3. Contents covers all seven movements and 49 pages exactly once; bookmarks
...
5. Page 49 leads to a non-page ending state and then a five-question quiz;
   neither is counted as Page 50; the ending links to nothing unpublished.
...
Write `books/three-musketeers-vol1/qa/_publication/reader-critic.md` with a concise
